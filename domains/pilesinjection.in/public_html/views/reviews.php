<?php 
    ...
    */
    ...
    $place_ID       = 'ChIJBSjsVgTCwjsR1F66Dnfw7CQ';
    $business_type  = 'MedicalClinic';
    $business_name  = 'Ketki Piles Injection Clinic';
    $street_address = 'Ketki Piles Injection Clinic, National Highway 65, Bankar Colony, Gadital, Hadapsar, Pune, Maharashtra, India';
    $locality       = 'Hadapsar, Pune'; // Example: Docklands (http://schema.org/addressLocality)
    $region         = 'Pune';
    $post_code      = '411028';
    $logo_path      = 'logo.png';
